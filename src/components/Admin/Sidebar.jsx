...
export default function Sidebar() {
  ...
  return (
    <>
      <nav className="md:left-0 md:block md:fixed md:top-500 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white-300 flex flex-wrap items-center justify-between text-blue-900  relative md:w-64 z-10 py-4 px-6">
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                <Link
                  className="text-blueGray-700 hover:text-pink-500 text-xs uppercase py-3 font-bold block"
                  to="/"
                >
