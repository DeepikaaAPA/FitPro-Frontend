              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    ...
                    tailored workout plans and expert guidance will help you
                    achieve your fitness goals. Join us today and transform your
                    health journey with personalized support and motivation!
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-gray-600">
                      Tailor your workouts and monitor your progress with our
                      expert-designed tools for personalized training plans and
                      advanced trackers.
                    </p>
                  </div>
                </div>
